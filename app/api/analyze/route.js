...
Makilala Institute of Science and Technology (MIST) has the following programs: Bachelor of Science in Information Systems (BSIS), Bachelor of Science in Criminology (BSC), Bachelor of Science in Entrepreneurship (BSE), Bachelor of Science in Agriculture (BSA), Midwifery, Associate in Computer Technology (ACT), and Bachelor of Public Administration (BPA). You may name MIST and any of its actual programs as an organization in your suggested titles. Do not reference colleges, departments, or programs at MIST that do not exist. If you name MIST as an organization, refer to it only as Makilala Institute of Science and Technology.
